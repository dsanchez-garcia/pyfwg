...
class MorphingWorkflow:
        ...
        for epw_path in epw_files:
            ...
            if input_filename_pattern:
                ...
                if match:
                    ...
                    logging.warning(f"Pattern did not match '{epw_base_name}'. Skipping."); continue
    ...
    def preview_rename_plan(self,
        ...
        """
        STEP 2: Generates a plan for all possible files that the tool will create.
        """
    ...
    def execute_morphing(self, *,
        ...
        Individual `fwg_` arguments will override any values in the `fwg_params` dictionary.
        """
        ...
        # --- Build the final FWG parameters with override logic ---
        final_fwg_params = fwg_params.copy() if fwg_params else {}

        # Collect explicit arguments into a dictionary
        overrides = {
        ...
        # Update the base dictionary with the explicit arguments
...
#         epw_files=['sevilla_uhi_tipo-1.epw'],
#         keyword_mapping={'city': {'seville': ['sevilla']}, 'uhi': {'type_1': ['tipo-1']}}
#     )
...
#     )
#
#     # --- Example of calling execute_morphing with the override logic ---
#     #
#     # base_parameters = {
#     #     'gcms': ['CanESM5', 'MIROC6'],
#     #     'create_ensemble': False # Base setting
#     # }
#     #
#     # workflow.execute_morphing(
#     #     fwg_jar_path='path/to/your.jar',
#     #     fwg_params=base_parameters,
#     #     # This explicit argument will override the value in fwg_params

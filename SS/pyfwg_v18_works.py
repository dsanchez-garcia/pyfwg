    ...
    def preview_rename_plan(self,
        ...
        Args:
            ...
            scenario_mapping (Optional[Dict[str, str]], optional): A dictionary
                to translate the tool's raw scenario names (e.g., 'ssp126')
                into a more descriptive format (e.g., 'SSP1-2.6') for use in
                the output filename. Defaults to None.

        Raises:
            RuntimeError: If `map_categories()` has not been run first, as there
                is no data to generate a plan from.
        """

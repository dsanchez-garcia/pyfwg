...
class MorphingWorkflow:
    ...
    def map_categories(self,
        ...
        if not input_filename_pattern and not keyword_mapping: raise ValueError("You must provide at least one mapping method: 'input_filename_pattern' or 'keyword_mapping'.")
    ...
    def execute_morphing(self, *,
        ...
        :param fwg_show_tool_output: If True, prints the FWG tool's console output in real-time. Defaults to False.
        ... (other params)
        """
    ...
    def _process_generated_files(self, source_epw_path: str, temp_dir: str):
        ...
        for generated_file in os.listdir(temp_dir):
            ...
            # Robust check: see if an expected key is a substring of the generated file

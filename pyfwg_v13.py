...
class MorphingWorkflow:
    ...
    def set_morphing_config(self, *,
        ...
        overrides = {
            'show_tool_output': fwg_show_tool_output, 'gcms': fwg_gcms, 'create_ensemble': fwg_create_ensemble,
        ...
        self.inputs.update({
            'fwg_jar_path': fwg_jar_path, 'fwg_params': final_fwg_params,
        ...
        print("\n  --- FutureWeatherGenerator Parameters ---")
        for key, value in self.inputs['fwg_params'].items():
            print(f"    - {key}: {value}")
    ...
    def execute_morphing(self):
        ...
        if self.inputs.get('run_incomplete_files', False):
    ...
    def _execute_single_morph(self, epw_path: str, temp_output_dir: str) -> bool:
        ...
        show_output = params.get('show_tool_output', False)

...
# jar_path = r"D:\OneDrive - Universidad de Cádiz (uca.es)\Programas\FutureWeatherGenerator_Europe_v2.0.2.jar"

epw_file = 'epws/wo_pattern/GBR_London.Gatwick.037760_IWEC_uhi_type-2.epw'

# La validación se ejecuta automáticamente.
created_files_custom = morph_epw_europe(
    epw_paths=epw_file,
    fwg_jar_path=jar_path,
    output_dir='./custom_output_europe_v1',
...
created_files_custom = morph_epw_global(
    epw_paths=epw_file,
    fwg_jar_path=jar_path,
    output_dir='./custom_output_global_v3',
    fwg_show_tool_output=True,
    delete_temp_files=False,
    fwg_gcms=['CanESM5'], # Usar solo dos GCMs
    fwg_interpolation_method_id=2,  # Usar el método "nearest point"
